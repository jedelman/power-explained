...
I was also instructed when to use that training, that power. I will talk about it but I will not pass it on lightly, because, just like all the other martial arts, it can be misused. I was instructed only to use it to 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNjYxMTkzMDUsLTE3NzQ4MzY2NzksOD
