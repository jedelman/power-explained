...
export default function App() {
  ...
  const handleSelectNode = useCallback((id) => {
    ...
    if (!node) return
    // Depth nodes 0-1: not selectable
    if (node.type === 'depth' && node.depth <= 1) return
    setSelectedId(id)
    setDrawerOpen(true)
    // Auto-expand depth to show the selected node
    ...
    <ThemeProvider theme={darkTheme}>
      ...
      <div style={{
        ...
        <div style={{
            ...
            <Slider
              ...
              sx={{
                ...
                '& .MuiSlider-thumb': {
                  width: 10, height: 10,
                  background: '#d4604f',
                  '&:hover, &.Mui-focusVisible': { boxShadow: '0 0 0 4px rgba(212,96,79,0.15)' },
                },
          ...
          {/* Link to power-explained */}
          <a
            href="https://jedelman.github.io/power-explained/"
            target="_blank"
