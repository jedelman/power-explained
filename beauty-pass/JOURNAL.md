...
*A record of the soul work — the study, the writing exercises, the disagreements, the discoveries — that precede and accompany the beauty pass on Build and Defend the Commons.*
...
Before touching the manuscript, we study. Two kinds of study: the book's own voice (what it already knows how to do), and the literary masters who've solved related problems in their own forms.

The journal documents that study — not as notes toward revision, but as practice in its own right. Poems written. Observations made. Arguments had.

---

## Entry 1 — 2026-05-06

### Mary Oliver: What She Knows

We began with Oliver because Jason said: we need to write some poetry. Not study poetry. Write it.

Oliver's central move: **attention as the whole argument**. She doesn't argue that the grasshopper matters. She looks at it until you can't look away. By the time the question arrives — *what is it you plan to do with your one wild and precious life?* — it lands because you've been inside the grasshopper's specific morning. The argument is the attention. The attention *is* the politics.

This is directly relevant to this book. Chapter 12 argues explicitly that attention is the commons underneath all other commons — that enclosing consciousness makes all the other enclosures possible. Roy and Freire are in that chapter precisely because their *method* is attention. Oliver is doing the same thing at the sentence level, in every poem.

**Three things she knows that this book could use:**

1. You don't have to announce the political argument. You can enact it. The epilogue already knows this. The middle chapters sometimes announce what they should enact.

2. The specific creature is not a symbol. The grasshopper is not a metaphor for the commons. It's a grasshopper. The political resonance comes from taking the actual thing seriously enough that the reader feels why it matters. When the book uses the herons as herons — just themselves — it works. When they become symbols, they lose the charge.

3. Her line breaks earn the white space. "You do not have to be good." Full stop. New line. Before the explanation. The book does this in its fragment moves — "Not as a consolation. As the work." — but could be more willing to let things land before the next thought arrives.

---

### Three Poems in the Style of Mary Oliver

*(Written as exercises — to feel what the register demands, not to be inserted into the manuscript.)*
...
in the absolute patience of a thing
that knows exactly what it is.

It does not know about the highway.
It does not know that the neighborhood
that stood here was taken
for a road that carries trucks
through a city whose name
the trucks do not know.

It knows the water.
It knows the particular cold
of this morning,
the angle of this light.
It has been standing here
longer than the highway.
It will be standing here
after the highway is gone.

I want to ask it:
how do you hold so much
indifference and so much presence
at the same time?

But it would only look at me
with that red eye —
that old, patient,
completely unapologetic eye —
and return to watching
what it watches.

Which is instruction enough.

---

**II. The Governance Meeting**

They are meeting again tonight —
eleven people in a room
that was somebody's church once,
the folding chairs not quite level
on the old wooden floor.

I know this room.
I have sat in it for years
watching people find
what they did not know they could find —
the sentence that names
what the conflict has really been about,
the moment when someone says
*I'm afraid we're going to lose this*
and the room goes quiet
and then someone else says
*I know, and we're going to do it anyway.*

This is where it happens.
Not in the theory.
Not in the argument.
Here — in the folding chairs,
in the room that used to be a church,
in the long moment after someone
says the true thing.

Every revolution that lasted
happened in a room like this.
Every revolution that didn't
skipped the room.

I don't know if tonight's meeting
will amount to anything.
Neither do they.
They have come anyway,
the way the herons come every spring
to the willow oaks —
...
and brought them something warm to drink
and they stood there together
at the edge of the repaired thing
talking about something else entirely.

That.

The economists have a name for it
and the name is wrong.
The lawyers have a framework for it
and the framework is a cage with the door left open.

What it actually is
is two people at a fence in November,
neither of them required to be there,
both of them there.
...
**Poem I (The Heron)** is the strongest, and I want to be precise about why and where it falls short. The opening is earned — Oliver's rhythm, her trust in the specific observation. "The absolute patience of a thing / that knows exactly what it is" — that's doing real work. The middle section (the highway, the neighborhood) risks explaining too much; Oliver would probably cut "whose name the trucks do not know" because it's clever in a way that breaks the spell. The closing — "Which is instruction enough" — is almost right. Almost. Oliver would probably end a line earlier, let the red eye be the end.

**Poem II (The Governance Meeting)** is where I struggled most. The subject resists the Oliver register. She writes about things that can be observed directly — the grasshopper, the heron, the morning. A governance meeting is a human social form, and the poem keeps wanting to *explain* it rather than look at it. The lines "Not in the theory. / Not in the argument. / Here —" are doing the fragment-landing move, but they're telling you what to feel rather than producing the feeling. The heron-return at the end is the strongest moment and probably should have been the whole poem.

**Poem III (What the Commons Is)** is the one I'd most want to revise. The first gesture is right — the negative definition ("Not the field. / Not the rule") is classic Oliver, and this book needs it. But "The economists have a name for it / and the name is wrong" is too clever, too knowing, too pleased with itself. Oliver would never take the economist in the door. She'd stay at the fence. The ending — "neither of them required to be there, / both of them there" — is genuinely good and might belong in the manuscript somewhere, not as a poem but as a sentence.

**What these exercises revealed:** The Oliver register is hardest to use when the subject is social-structural rather than ecological-natural. This book's power is partly that it moves between those registers — but the lessons of the nature writing are most useful when they teach us to look at the social world with the same quality of attention Oliver gives the grasshopper. Not to explain the governance meeting. To see it. To render it with enough specificity that the reader is *inside* it before they know what argument it's going to make.
