...
id: G-08-019a
plateau: P-08
title: Crenshaw was not first
slug: crenshaw-was-not-first
tags:
  - plateau/P-08
  - voice/jason
  - status/draft
  ...
  - emotion/vindication
notes: |
  Inserted 2026-06-04 during the intersectionality chapter pass. The
  Combahee River Collective predated Crenshaw's theoretical naming of
  intersectionality by twelve years, working from a Black feminist
  socialist lesbian position in Boston (1974 founding, 1977 Statement).
  Placed at the section boundary between Crenshaw's implications gesture
  (G-08-019) and Davis (G-08-020) as the practical-lineage bridge:
  Crenshaw's theoretical name came from collective practice already
  underway; Davis continued it.

  Verified facts: collective named for Harriet Tubman's June 1863
  Combahee River raid (she led ~750 enslaved people to freedom);
  founders Barbara Smith, Beverly Smith, Demita Frazier; Combahee
  River Collective Statement issued 1977. Quoted phrasings ("the major
  systems of oppression are interlocking" and "If Black women were
