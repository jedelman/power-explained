...
id: G-CC-001
plateau: P-CC
title: There is a demon that never
slug: there-is-a-demon-that-never
tags:
  - plateau/P-CC
  - voice/jason
  - status/draft
  ...
  - practice/naming
notes: |-
  COMPOSED (composition pass, C1 — "The Corruption of the Common" interlude).
  Jason directive (session 2026-06-XX): its own treatment, connected to demons
  (the Goetia frame), open web as the case, read-and-name mode, deterritorializing
  rupture as the reader's work, BRACING. Staged draft, not in the canonical river.
