...
id: G-02-036
plateau: P-02
title: What Catalonia outlasted
slug: catalonia-has-outlasted-most-of-the
tags:
  - plateau/P-02
  - voice/jason
  - status/draft
  ...
  - year/1714
  - year/1978
  - concept/anti-imperial
  - concept/longue-duree
  - motif/durability
notes: |
  Leverage item, inserted between CNT (G-02-028) and 1979 (G-02-029). Per
  Jason's call: Catalonia had no imperial ambition and has outlasted
  empires by doing so. Frames the anti-imperial posture as a deep
  political condition that Barcelona's twenty-first-century coalitions
  inherit.

  Acknowledges the Crown of Aragon's Mediterranean reach (Sicily, Sardinia,
  Naples briefly under Alfonso V) so the claim is honest — Catalonia
  hasn't been entirely outside imperial activity in all eras — and then
  pivots to the modern Catalan political imagination, especially post-1714,
  which has been organized around region/language/working-class culture
  rather than imperial projection.
