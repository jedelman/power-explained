...
plain: >
  ...
  a trail. Each time someone passes, the ground packs down a little more.
  In time the path holds, and the body just follows it without thinking.
  Common sense is the trail, not the choice. A tracker reads the same
  ground in a different way. The tracker reads the signs. The tracker
  builds a map in the body of the whole land, and of the forces that
  pressed the trail into it.
plain_meta:
  source: G-01-013
  status: draft
---
