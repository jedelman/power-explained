...
beauty_check:
  passed: false
  notes: |
    2026-05-23: Draft. The mirror of "mine". The reader is asked to
    name theirs in their own life — not on the page, not in a
    notebook, in the room they actually live in. Keep the gesture
    short; the work is the reader's, not the prose's. The question
    form is deliberate: the chapter ends in a question for the reader
    that the page cannot answer.
notes: |
