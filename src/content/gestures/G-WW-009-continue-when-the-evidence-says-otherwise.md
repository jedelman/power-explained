...
beauty_check:
  passed: false
  notes: |
    2026-05-23: Draft. CONTINUE — the sixth capacity, this chapter's
    primary capacity. The one the chapter is named after — the
    walking. Plain. Hand it off to the next gesture (the six become
    one motion).
notes: |
