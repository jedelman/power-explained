...
<div class="callout">
  ...
  <p>Baudrillard's method in <em>The System of Objects</em> is close reading of the object-world — furniture catalogues, appliance manuals, interior design magazines — with the tools of semiology. His analysis of the modern kitchen is characteristic. The contemporary kitchen is not organized around cooking. It is organized around the display of a system of signs: the coordinated surfaces, the matching appliance finishes, the ergonomic layout that signifies rationality, the stainless steel that signifies hygiene and modernity.</p>
  <p>None of this is about food. The kitchen-as-sign system is organized around meanings — cleanliness, modernity, rationality, domestic competence performed for a social audience — that have only a contingent relationship to the actual preparation of meals. The refrigerator in this kitchen is not primarily a cooling device. It is a term in a sign system, and its meaning derives from its relationship to the other terms — the hob, the worktop, the splashback — more than from its function.</p>
</div>
...
<p>This connects to <a class="xl" href="debord-1968.html">Debord's spectacle</a> but extends it in a specific direction. For Debord, the spectacle replaces lived experience with its image. For Baudrillard, the consumer code replaces need with its simulation — produces not just images of desirable things but the very structure of desiring. <a class="xl" href="deleuze-guattari.html">Deleuze and Guattari's</a> insight that desire is productive rather than simply responsive — that desire doesn't pre-exist its objects but is produced through the encounter with them — is the philosophical parallel: and that production can be organized.</p>` }} />
          </Section>
...
<p>His answer draws on Marcel Mauss's anthropology of the gift. In Mauss's analysis, the gift in pre-capitalist societies is not primarily an economic transaction. It is a mode of social relation — a way of creating and maintaining bonds between people through the giving and receiving and counter-giving of things that are inalienable from the relationships they express. The potlatch of Northwest Coast Indigenous peoples is the extreme case: the deliberate, competitive destruction of wealth as a demonstration of social power and generosity. The logic is the opposite of accumulation: value is produced not by keeping things but by giving them away.</p>
...
<p>By the mid-1970s, the theory has arrived at its destination. The consumer society of the <em>trente glorieuses</em> has produced a sign system so comprehensive that it has replaced the real as the operating medium of social life. The refrigerator that started as an object with a use-value and a sign-value has become a pure sign — a position in a code that refers to other signs rather than to any function or need or social relation outside the code. This is the hyperreal: not the simulation of something real, but a simulation that has consumed the real it was supposed to represent.</p>` }} />
          ...
          <Section id="enclosure" num="05" title="The enclosure of desire">
            <div dangerouslySetInnerHTML={{ __html: `<p>The consumer society Baudrillard analyzed in the 1970s was French and specific. The dynamic it expressed was global and generalizing. By the end of the decade, the Fordist settlement that had produced the <em>trente glorieuses</em> was ending — the oil shocks, stagflation, the beginning of deindustrialization. What replaced it, across the 1980s and 1990s, was not a different relationship between objects and signs but a more complete one: the financialization of the economy, the proliferation of media channels, and the emergence of what would eventually be called the attention economy — a system organized not around the production and sale of goods but around the capture and monetization of desire itself.</p>
<p>Baudrillard's three books, read in sequence, are a theory of this transition. <em>The System of Objects</em> documents the moment when use-value becomes subordinate to sign-value. <em>The Consumer Society</em> documents the moment when the code replaces need as the structure of desire. <em>Symbolic Exchange and Death</em> documents the moment when the code becomes self-referential — when simulation has consumed the real it was supposed to represent. These are not three separate phenomena. They are three stages of the same enclosure, applied to the deepest level of social life.</p>
