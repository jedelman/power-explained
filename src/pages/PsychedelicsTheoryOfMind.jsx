...
<div class="callout">
  ...
  <p><a class="xl" href="reich-character-armor.html">Reich's character armor</a> is, in Bateson's terms, a somatic expression of the epistemological error: the armored self treats its own body as a system to be controlled rather than a process to be inhabited. <a class="xl" href="shannon-simondon-1950s.html">Shannon's channel model</a> is the error built into technical infrastructure: communication treated as the transmission of signals between separate units rather than the modification of a shared relational field. <a class="xl" href="debord-1968.html">The spectacle</a> is the error at the level of social life: the self relates to its experience through its representation, treating the image as a thing it possesses rather than a process it participates in.</p>
  <p>The psychedelic experience, in Bateson's framework, is one of several conditions — including deep aesthetic experience, certain forms of religious practice, what he called "the experience of grace" — in which the epistemological error temporarily dissolves: the boundary between self and world becomes permeable, the sense of isolated selfhood relaxes, and the pattern that connects organism and environment becomes directly perceptible. The political implication is exact: if the enclosure of the mind is partly maintained by this error — by the chronic sense of isolated selfhood that makes the spectacle's promise of connection-through-consumption feel necessary — then any experience that dissolves the error is, structurally, a breach in the enclosure.</p>
</div>
...
<p>What connects Huxley and Laing to Bateson is the common underlying claim: the ordinary self — the self that consumes the spectacle, defers to hegemonic common sense, maintains its character armor, moves through the managed routes of the city — is not the only possible self. It is a construction, maintained by active work at every level from the muscular to the institutional. And any practice that interrupts that construction, however temporarily, is a direct breach of the enclosure at its most fundamental level.</p>` }} />
          </Section>
...
<p>The closure operated through several mechanisms at once. Legal criminalization made the substances inaccessible and their use a felony, dispersing the communities organized around them and making serious research impossible for fifty years. Cultural absorption worked on what criminalization left: the counterculture's imagery was rapidly incorporated into advertising, fashion, and mass entertainment — the image of consciousness expansion became a commodity before the practice was criminalized. And the severing of the associated milieu — in Simondon's terms — may have been the most decisive. The psychedelic experience, like any practice that produces genuine change, requires a community of practice to be politically generative rather than merely personally interesting. The ceremonial containers that Indigenous traditions had developed over centuries, the integration work that therapeutic traditions emphasized — these are all forms of associated milieu. Criminalization dispersed those communities. What remained was the individual experience, stripped of collective context, which is exactly how the wellness industry has repackaged it fifty years later.</p>
<div class="pull">
