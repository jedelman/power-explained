      ...
      <ArticleWrap>
        ...
        <div className="body-text">
          ...
          <Section id="the-claim" num="01" title="The interior claim: consciousness as commons terrain">
            <div dangerouslySetInnerHTML={{ __html: `<p>Stripped of counterculture decoration, the claim is precise: <strong>ordinary waking consciousness is not a neutral baseline.</strong> It is a produced state — and it can be otherwise. The experience of being otherwise — temporarily, chemically, under conditions that dissolve the filters through which ordinary consciousness constructs its world — reveals that the ordinary is constructed, selective, and maintained by active work that the ordinary itself conceals.</p>
