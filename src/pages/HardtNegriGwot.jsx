...
const FOOTNOTES = [
  `Hardt, M. & Negri, A. (2000). <em>Empire</em>. Harvard University Press. The book was written before September 11 and published in 2000. Its prediction — that the global order would be managed through a network of institutions rather than a single hegemonic state, that sovereignty had become decentered and that wars would be fought not between nations but as police actions against those who resisted the system — appeared prescient within a year of publication. The GWOT fit the Empire framework better than it fit the frameworks of either liberal internationalism or classical Marxism, which is one reason the book found readers across an unusually wide range. <a href="#ref1">↩</a>`,
  `Hardt, M. & Negri, A. (2004). <em>Multitude: War and Democracy in the Age of Empire</em>. Penguin Press. This is the book written directly in response to the GWOT, and the argument about war as a form of biopower — as the management of life and death at a global scale rather than the achievement of political objectives by military means — runs through it. Their concept of "global civil war" — the GWOT as a permanent state of exception that produces the legal conditions for indefinite executive power — draws on Agamben's <em>State of Exception</em> (2003) and Carl Schmitt's analysis of the exception as the ground of sovereignty. <a href="#ref2">↩</a>`,
  `The USA PATRIOT Act (Uniting and Strengthening America by Providing Appropriate Tools Required to Intercept and Obstruct Terrorism) was passed on October 26, 2001 — 45 days after September 11, with minimal congressional debate. Its surveillance provisions — expanded wiretapping authority, roving wiretaps, "sneak and peek" searches, National Security Letters requiring recipients not to disclose the request — targeted communication infrastructure specifically: email, telephone, financial records, library borrowing. The FISA Amendments Act of 2008 and the subsequent revelations of the Snowden documents (2013) confirmed that the surveillance had been applied far beyond counterterrorism contexts to the comprehensive monitoring of global communications. The legal architecture was not designed for a specific threat. It was designed for permanent access to the commons of communication. <a href="#ref3">↩</a>`,
  `The photographs from Abu Ghraib prison, published in April 2004, documented systematic abuse of Iraqi detainees by US military personnel. The specific forms of abuse — sexual humiliation, forced nakedness, stress positions, mock execution — were not random cruelty. They were techniques developed through the SERE program (Survival, Evasion, Resistance, Escape), reverse-engineered from Chinese Communist interrogation methods, and applied to produce "learned helplessness": a state of total passivity and compliance produced by stripping the subject of any sense of agency or dignity. The connection to Reich's analysis of character armor is precise: the techniques targeted the somatic substrate of selfhood — the body's sense of its own boundaries, its capacity for resistance, its embeddedness in a community that gives it meaning. The goal was not information extraction (the techniques are unreliable for that purpose, as military psychologists testified). The goal was the production of armored passivity at scale. <a href="#ref4">↩</a>`,
  `Agamben, G. (2005). <em>State of Exception</em>, trans. K. Attell. University of Chicago Press. (Orig. Italian: <em>Stato di eccezione</em>, Bollati Boringhieri, 2003.) Agamben's argument — that the state of exception, far from being an emergency measure, has become the permanent operating mode of the contemporary state — is the legal-philosophical complement to Hardt and Negri's biopolitical analysis. The "war on terror" created a permanent exception: a space outside the law in which sovereign power could be exercised without legal constraint. Guantánamo Bay is its paradigm case: a space deliberately located outside any legal jurisdiction, where bodies could be held indefinitely without charge, tried by military commissions that did not observe the rules of evidence, and subjected to treatment that would be illegal in any jurisdiction that recognized the Geneva Conventions. <a href="#ref5">↩</a>`,
]
...
<p>Hardt and Negri wrote <em>Multitude</em> (2004) directly in response, naming the GWOT as a form of biopower: not war in the classical sense of achieving political objectives through military force, but the permanent management of a global population — the production, through the state of exception, of legal conditions under which sovereign power could be exercised without constraint.<sup><a href="#ref2" id="ref2">2</a></sup> The war on terror was not a temporary emergency measure. It was infrastructure. It was the Enclosure Acts for the common intellect.</p>` }} />
          </Section>

          <Section id="immaterial-enclosure" num="02" title="The immaterial enclosure: the common intellect as terrain">
            <div dangerouslySetInnerHTML={{ __html: `<p>The through-line this series has been building runs here with unusual clarity. The original enclosures — the ones <a class="xl" href="kropotkin.html">Kropotkin</a> and the commons theorists analyzed — took the physical commons: the pasture, the forest, the fishery, the shared land that sustained subsistence life outside the wage relation. The enclosure required fences, legal instruments, and the state's coercive power to enforce them. What was enclosed was a material substrate of production.</p>
<p>The enclosures Hardt and Negri analyze operate on a different substrate: the common intellect — the shared language, knowledge, cultural memory, relational capacity, and communicative infrastructure through which all immaterial production draws. You cannot enclose language with a fence. You cannot make knowledge scarce by statute without actively destroying it. The enclosure of the common intellect requires a different set of instruments: intellectual property regimes that manufacture scarcity where none exists, platform architectures that capture the social graph, surveillance systems that monitor the flows of communication and make them available to the state and to capital, legal frameworks that criminalize the unauthorized use of shared cultural material.</p>
...
<p>The PATRIOT Act's surveillance architecture did not appear from nowhere. It was the legal formalization of technical capacities that the NSA had been developing since the 1970s, and that the commercial internet had been generating as a byproduct of its normal operations since the 1990s. What the GWOT provided was the political legitimacy to deploy those capacities openly, to make the enclosure of communication infrastructure a matter of national security rather than a corporate privacy question, and to immunize the technology companies that cooperated from legal liability. The emergency created the infrastructure. The infrastructure outlasted the emergency. The emergency, as Agamben had predicted, was permanent.<sup><a href="#ref5" id="ref5">5</a></sup></p>` }} />
          </Section>

          <Section id="bodies" num="04" title="The bodies at the limit: Abu Ghraib and the biopolitics of terror">
            <div dangerouslySetInnerHTML={{ __html: `<p>The photographs from Abu Ghraib prison, published in April 2004, showed something that most commentary on them refused to name directly: the techniques were not random cruelty or the sadism of bad actors. They were a system.<sup><a href="#ref4" id="ref4">4</a></sup></p>
<p>The specific forms of abuse documented — sexual humiliation, forced nakedness, stress positions, sensory deprivation, mock execution — were techniques developed through the SERE program, reverse-engineered from Chinese Communist interrogation methods used on American POWs in Korea, and applied at Abu Ghraib, Guantánamo, and the CIA's black sites under legal memos that redefined torture as anything short of organ failure. The techniques had a documented purpose, named in the military psychology literature that informed them: the production of "learned helplessness." A state of total passivity and compliance produced by systematically stripping the subject of any sense of agency, any sense that their actions have consequences, any embeddedness in a community that gives them meaning.</p>
<p>The connection to <a class="xl" href="reich-character-armor.html">Reich's analysis</a> is not metaphorical. It is precise. Character armor, in Reich's framework, is the body's organization around the management of threat — the chronic muscular tension that keeps the subject functional in a repressive environment. Abu Ghraib's techniques were designed to destroy that organization: to produce a body that cannot sustain the armoring that makes resistance possible. Not broken in the sense of damaged — broken in the sense of de-organized, reduced to a state of pure passivity that the interrogator can direct.</p>
...
<p><a class="xl" href="gramsci-1930s.html">Gramsci's hegemony</a> operates through the constitution of common sense. The GWOT's contribution to the enclosure of the mind was the constitution of a specific common sense: that the world is divided between those who are safe and those who are threats, that security requires surveillance, that the commons of communication is a vector of danger rather than a condition of freedom. This common sense was produced — not by argument but by the continuous management of fear as an affective state, a somatic condition, a permanent low-level activation of the threat-response that <a class="xl" href="reich-character-armor.html">Reich</a> would have recognized as the political deployment of armoring at civilizational scale.</p>` }} />
          </Section>
...
<p>The arc is not a story of progress interrupted. It is a story of enclosure deepening — moving inward, from the physical commons to the institutional commons to the technical commons to the perceptual commons to the interior commons of consciousness to the common intellect itself. Each layer of enclosure is built on the layers beneath it, and each creates the conditions for the next. The armored bodies Reich analyzed were the substrate on which <a class="xl" href="gramsci-1930s.html">Gramsci's hegemonic institutions</a> operated. The hegemonic institutions were the context within which <a class="xl" href="shannon-simondon-1950s.html">Shannon's channel model</a> was built into infrastructure. The channel infrastructure was the medium through which <a class="xl" href="debord-1968.html">the spectacle</a> organized social life. The spectacle was the environment within which <a class="xl" href="baudrillard-consumer-society.html">the consumer code</a> constituted desire. The consumer code was what the interior frontier of <a class="xl" href="psychedelics-theory-of-mind.html">consciousness</a> had to dissolve to be free. The dissolution of the interior frontier was what <a class="xl" href="drug-war-deleuze-synthesizers.html">the drug war and the culture war</a> were organized to prevent. And all of it — the armoring, the hegemony, the channel, the spectacle, the code, the closure of the interior — was the preparation for the enclosure of the common intellect that the GWOT's surveillance architecture made permanent.</p>
...
<p>The arc closes here. But the series does not end with the GWOT — because the enclosure did not end there either. The surveillance infrastructure built after September 11 became the template for the commercial surveillance apparatus that platforms deployed in the following decade. The management of the common intellect through fear became the management of attention through engagement. The Patriot Act's monitoring of communication flows became Cambridge Analytica's modeling of political desire. And then, in 2022, the enclosure of the common intellect found its most comprehensive instrument yet: the large language model, trained on the full output of the common intellect, deployed as infrastructure, optimized for the channel metrics that <a class="xl" href="shannon-simondon-1950s.html">Shannon</a> had made foundational.</p>
<p>That is where the series ends — and where the question it has been building toward becomes most urgent. <a class="xl" href="ai-and-the-left.html">The next piece</a> is about AI and the left: what the enclosure of the common intellect looks like when it runs as software, and what it would mean to compose a commons from it rather than simply be enclosed by it.</p>` }} />
          </Section>
