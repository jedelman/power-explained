...
const SERIES = [
  ...
  { href: 'contents#series-v', eyebrow: 'Series V', title: 'Where We Go From Here', desc: 'Credit is the original commons. Land can be held permanently in trust. Care rebuilt collectively. AI governed by the people it was trained on.', count: '7 pieces · Start: One Pattern', dark: true },
  { href: 'enclosure-of-the-mind', eyebrow: 'Series VI — New', title: 'Enclosure of the Mind', desc: 'The enclosure of physical commons is well-documented. The enclosure of mind — desire, consciousness, the common intellect — is still underway. Nine pieces, one century, one argument.', count: '9 pieces · Start: Reich', dark: false },
