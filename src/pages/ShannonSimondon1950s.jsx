...
<div class="callout">
  ...
  <p>Technical objects stripped from their associated milieus degrade. They work less well, they lose their capacity for development, and the human communities organized around maintaining them dissolve. A tool taken from the community of practice that developed it becomes, over time, just a mechanism — something that can be operated but not understood, replaced but not repaired, used but not extended.</p>
  <p>Shannon's channel is a technical object designed to be milieu-independent: it works the same regardless of what flows through it, who operates it, or what community it serves. This is a feature from the engineering perspective — it's what makes the channel universally deployable, what allows AT&T to own a phone network that serves everyone without understanding anyone. It's also what makes the channel the perfect instrument of enclosure: a technical object with no associated milieu has no community to defend it, no practice to sustain it, no human gesture encoded in it that resists being directed toward any purpose its owner chooses.</p>
</div>
