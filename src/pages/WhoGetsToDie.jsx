    ...
    >
      ...
      <ArticleWrap>
        ...
        <div className="body-text">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>Michel Foucault argued that modern power is not primarily about the sovereign's right to kill. It's about the administration of life — who gets healthcare, who gets housed, who gets educated, who gets to reproduce under what conditions. He called this biopower: power exercised through the management of living populations rather than through the spectacle of execution.</p>
