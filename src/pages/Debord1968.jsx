...
<p>The earlier enclosures — the ones <a class="xl" href="kropotkin.html">Kropotkin</a> and <a class="xl" href="hardin-was-wrong.html">the commons theorists</a> analyzed — had taken the land, the forests, the fisheries: the physical commons that sustained subsistence life outside the wage relation. What Debord was watching in the late 1950s was a second enclosure, operating on different terrain. Not the land beneath people's feet but the experience in front of their eyes. Not what they could grow or gather but what they could feel, desire, and imagine. The commodity was no longer just a thing produced and sold. It was becoming the medium through which social life itself was conducted.</p>
<p><a class="xl" href="shannon-simondon-1950s.html">Shannon had built the channel through which this could flow.</a> <a class="xl" href="gramsci-1930s.html">Gramsci had mapped the institutional infrastructure that would manage it.</a> <a class="xl" href="reich-character-armor.html">Reich had described the armored bodies that would receive it.</a> Debord named the system those elements produced when assembled at scale. He called it the spectacle.</p>` }} />
          </Section>
...
<p>The question May '68 left open — and that Debord spent the rest of his life failing to answer — is the same question this series is tracking: what does it look like to build something outside the enclosure, when the enclosure has learned to incorporate everything built against it? <a class="xl" href="reich-character-armor.html">Reich's armored bodies</a> need somatic work before ideology changes anything. <a class="xl" href="gramsci-1930s.html">Gramsci's counter-hegemony</a> requires building institutions over generations. <a class="xl" href="shannon-simondon-1950s.html">Simondon's associated milieu</a> requires reconstructing communities of practice that the channel model dissolved.</p>
<p>None of these answers is fast. The spectacle is fast. It can absorb in months what takes years to build. The asymmetry is real and is not solved by analysis, however precise. What Debord provides is the clearest possible statement of the problem — which is not nothing, and is in fact the prerequisite for any answer that is not simply another image of an answer.</p>
