...
<p>Baudrillard's claim is that capitalism destroys symbolic exchange and replaces it with a closed system of signs that refer only to each other. The consumer object does not create social bonds; it marks social positions. It is not given; it is purchased. The social relation in consumer society is not the gift relation but the sign relation — and the sign relation is, in Baudrillard's analysis, a relation of radical isolation: each consumer, positioned in the code by their possessions, is alone in a crowd of signs.</p>
<div class="callout">
