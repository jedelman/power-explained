...
<p>The framework came before the site. A structured reading sequence — Kropotkin → Gramsci → Benjamin → Debord → Baudrillard → Deleuze &amp; Guattari → Hardt &amp; Negri — produced a working theory about power, capture, and the commons. That theory is the backbone. Everything on this site is either an application of the framework to a specific domain, or evidence for a claim the framework makes.</p>
